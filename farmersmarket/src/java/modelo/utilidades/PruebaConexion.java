...
public class PruebaConexion {
    ...
    public static void main(String[] args) {
        ...
        rolesActual = roles.obtenerRolesParaUsuario(64569185);
        ...
        System.out.println("----------------------------------");
        System.out.println(rolesActual.get(0));
        
        System.out.println("----------------------------------");
        
        if (Correo.sendMail("Asunto del Mensaje", " Cuerpo del Mensaje.", "thekenyr@gmail.com")) {
