...
public class GeneradorReportes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (sesion.getAttribute("producto") != null) {
            ...
            List<ReporteProductoDto> reportes = (List<ReporteProductoDto>) sesion.getAttribute("producto");

            try {
                JasperReport reporte = (JasperReport) JRLoader.loadObject(getServletContext().getRealPath("reportes-jasper/productos.jasper"));
