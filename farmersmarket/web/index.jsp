...
<%
    ...
    if (actualUsuario != null || rolesActuales != null) {
        for (RolDto i : rolesActuales) {
            ...
            } else if (i.getIdRol() == 2) {
                response.sendRedirect("pages/indexc.jsp?msg=<strong><i class='glyphicon glyphicon-exclamation-sign'></i> ¡Permiso Denegado o no cerró sesión correctamente!</strong> No cerró sesión adecuadamente.&tipoAlert=danger");
            } else if (i.getIdRol() == 3) {
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="caption">
                        ...
                        <br>
                        <p>
                            <button href="#" class="btn btn-success" role="button" data-toggle="modal" data-target="#modalRegistrarse">Registrárse en Farmer's Market</button>
                            <button href="#" class="btn btn-primary" role="button" data-toggle="modal" data-target="#modalIniciarSesion">Iniciar Sesión</button>                            
                        </p>
                    </div>
                </div>
                                ...
                                <div class="modal-body">
                                    <form method="POST" action="GestionUsuarios" class="form-horizontal" id="formRecuperarClave">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="rcCorreo" name="rcCorreo" 
